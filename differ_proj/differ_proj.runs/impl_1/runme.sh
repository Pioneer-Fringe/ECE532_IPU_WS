...
HD_PWD='E:/ECE532/WorkSpace/IPU_proj/differ/differ_proj/differ_proj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rgb444diff.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rgb444diff.tcl -notrace
