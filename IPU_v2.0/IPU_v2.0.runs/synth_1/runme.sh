...
HD_PWD='E:/ECE532/WorkSpace/IPU_proj/main/IPU_v2.0/IPU_v2.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IPU.tcl
