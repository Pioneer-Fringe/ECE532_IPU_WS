...
#
# Generated by export_simulation on Wed Mar 27 23:02:49 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './vi_sys.sh' script.
...
./vi_sys.sh -noclean_files

For more information on the script, please type './vi_sys.sh -help'.
