...
HD_PWD='E:/ECE532/WorkSpace/IPU_proj/Verification/MB_Validation/MB_Validation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vi_sys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vi_sys_wrapper.tcl
