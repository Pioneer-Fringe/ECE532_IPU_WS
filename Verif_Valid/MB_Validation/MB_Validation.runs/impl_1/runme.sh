...
HD_PWD='E:/ECE532/WorkSpace/IPU_proj/Verification/MB_Validation/MB_Validation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vi_sys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vi_sys_wrapper.tcl -notrace
