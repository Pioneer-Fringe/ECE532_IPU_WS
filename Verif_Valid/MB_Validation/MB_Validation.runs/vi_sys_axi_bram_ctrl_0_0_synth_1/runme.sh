...
HD_PWD='E:/ECE532/WorkSpace/IPU_proj/Verification/tb_proj/MB_Validation/MB_Validation.runs/vi_sys_axi_bram_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vi_sys_axi_bram_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vi_sys_axi_bram_ctrl_0_0.tcl
